...
struct PeriodText: Codable, Equatable {
    let lesson: String?
    let substitution: String?
    let info: String?
}

struct PeriodElement: Codable, Equatable {
...
struct PeriodExam: Codable, Equatable {
    let id: Int64?
    let examType: String?
    let name: String?
    let text: String?
...
struct HomeWork: Codable, Equatable {
    let id: Int64
    let lessonId: Int64
    let date: Date
    let dueDate: Date
...
struct MessengerChannel: Codable, Equatable {
    let id: String
    let name: String
}